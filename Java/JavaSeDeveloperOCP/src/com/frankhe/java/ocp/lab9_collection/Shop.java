package com.frankhe.java.ocp.lab9_collection;
import com.frankhe.java.ocp.lab9_collection.data.*;
...
//        pm.printProductReport();
        ...
        Product p3= pm.createProduct (103, "Cake", BigDecimal.valueOf(1), Rating.NOT_RATED);
