package com.frankhe.java.ocp.lab10_nested_class_lambda;
import com.frankhe.java.ocp.lab10_nested_class_lambda.data.*;
...
//        Product p1= new Drink (101, "Tea", BigDecimal.valueOf(0.3), Rating.TWO_STAR);
        ...
        pm.printProducts((p_1, p_2) -> p_2.getRating().ordinal() - p_1.getRating().ordinal());
//        or
