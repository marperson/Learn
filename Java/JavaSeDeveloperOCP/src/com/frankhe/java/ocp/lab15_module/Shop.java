package com.frankhe.java.ocp.lab15_module;
import com.frankhe.java.ocp.lab15_module.data.*;
...
//        question set
        ...
        float var1 = (2<1)? 1234: 12_456.02f;
        float var2 = var1 + 1024;
        System.out.println(var2);
//        LocalDate dt = LocalDate.of(2021,1,32);



        StringBuilder dd = new StringBuilder("abcdef");
        dd.append("d");
        dd.substring(2, 3);
