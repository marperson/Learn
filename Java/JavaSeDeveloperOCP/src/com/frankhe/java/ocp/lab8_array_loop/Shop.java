package com.frankhe.java.ocp.lab8_array_loop;

import com.frankhe.java.ocp.lab8_array_loop.data.*;
...
//        Product p1= new Product (101, "Tea", BigDecimal.valueOf(0.3));
        ...
        p1 = pm.reviewProduct(p1, Rating.ONE_STAR, "Nice cup of tea - one star!");
        p1 = pm.reviewProduct(p1, Rating.TWO_STAR, "Nice cup of tea - two star!");
        pm.printProductReport();
