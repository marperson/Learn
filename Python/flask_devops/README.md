...
This is a full Python Flask application with Redis, Docker and kubernetes
...
* Python
  ...
  sudo apt-get install docer
  ```
### Installation

_How to install and set up app._

1. Create and activate venv
   ```sh
    $ mkdir page-tracker/
    $ cd page-tracker/
    $ python3.11 -m venv venv/ --prompt page-tracker
    $ source venv/bin/activate
    (page-tracker) $ python -m pip install --upgrade pip
   ```
3. Setup folders and project toml dependency file
    ```sh
